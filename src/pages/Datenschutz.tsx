      ...
      <div className="container mx-auto px-6 max-w-3xl">
        ...
        <div className="space-y-10 text-muted-foreground leading-relaxed">
          ...
          <section>
            ...
            <p className="mb-3"><strong className="text-foreground">Interne E-Mail-Benachrichtigung:</strong> Nach dem Absenden des Kontaktformulars wird automatisch eine interne Benachrichtigungs-E-Mail an Soul Cinema (hallo@soulcinema.de) ausgelöst. Der Versand erfolgt ausschließlich über das STRATO-Mailpostfach von Soul Cinema. Verarbeitet werden dabei die von Ihnen im Formular eingegebenen Kontakt- und Projektinformationen. Zweck ist allein die zeitnahe Bearbeitung Ihrer Anfrage. Es findet keine Eintragung in einen Newsletter und keine Weitergabe an Tracking- oder Marketinganbieter im Rahmen dieser Funktion statt.</p>
