...
export default function Datenschutz() {
  return (
    <main className="min-h-screen bg-background text-foreground py-20">
      <Seo
        title="Datenschutz — Soul Cinema"
        description="Datenschutzerklärung von Soul Cinema nach DSGVO: Verarbeitung von Kontaktanfragen, Hosting, Google Fonts und Rechte der Betroffenen."
        path="/datenschutz"
      />
