              ...
              <FadeUp key={p.id} delay={i * 0.07}>
                <div className={`relative h-full rounded-2xl p-8 gentle-animation ${
                  ...
                  <ul className="space-y-3 mb-8">
                    {features.map((f, idx) => (
                      <li key={idx} className="flex items-start gap-2.5 text-sm text-[#F4F0E8]/85">
                  ...
                  <a href="#contact" className={`block text-center w-full font-semibold py-3 rounded-md gentle-animation ${
                    p.highlighted ? 'bg-[#C9963B] text-[#0A0A0A] hover:bg-[#d9a64b]' : 'border border-[#C9963B]/40 text-[#F4F0E8] hover:bg-[#C9963B]/10 hover:text-[#C9963B]'
                  }`}>
